...
exports.sendContactConfirmation = exports.sendNewsletterConfirmation = void 0;
...
const getCompanyEmail = () => {
    var _a;
    try {
        return ((_a = functions.config().email) === null || _a === void 0 ? void 0 : _a.company) || 'info@transluga.com';
    }
    catch (error) {
